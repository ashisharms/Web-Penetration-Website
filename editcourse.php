...
$sql = "SELECT id as id,cname as name,cdes as cdes from courses";
$res = mysql_query($sql);
echo '<table width="100%">';
while($r=mysql_fetch_array($res,MYSQL_ASSOC))
{
echo '<tr><td>course Name</td><td>&nbsp;</td><td>Description</td><tr><tr><td>'.$r['name'].'</td><td>:</td><td>'.$r['cdes'].'</td>
<td><a href="edit.php?cid='.$r['id'].'">Edit</a></td><td><a href="delete.php?cid='.$r['id'].'">X</a></td></tr>';
}
echo '</table>';
?>
</div>
